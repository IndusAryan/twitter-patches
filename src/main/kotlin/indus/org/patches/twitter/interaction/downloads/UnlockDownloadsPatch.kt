...
import indus.org.patches.twitter.interaction.downloads.fingerprints.BuildMediaOptionsSheetFingerprint

@Patch(
    name = "Unlock Video and GIF downloads",
...
object UnlockDownloadsPatch : BytecodePatch(
    ...
    override fun execute(context: BytecodeContext) {
        ...
        // Allow downloads (for non copyrighted videos)
